      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo (session('dusername')); ?><span class="caret"></span></a>
              <ul class="dropdown-menu dropdown-menu-left">
                <li><a title="查看或修改个人信息" data-toggle="modal" data-target="#seeUserInfo">个人信息</a></li>
                <li><a id="record" title="查看您的登录记录" data-toggle="modal" data-target="#seeUserLoginlog">登录记录</a></li>
              </ul>
            </li>
            <li><a href="<?php echo U(outLogin);?>" onClick="if(!confirm('是否确认退出？'))return false;">退出登录</a></li>
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>web</td>
                  <td>125</td>
                  <td><a href="<?php echo U(update_category);?>?current=6">修改</a> <a rel="1">删除</a></td>
                </tr>
                <tr>
                  <td>2</td>
                  <td>后端程序</td>
                  <td>program</td>
                  <td>185</td>
                  <td><a href="<?php echo U(update_category);?>?current=6">修改</a> <a rel="2">删除</a></td>
                </tr>
                <tr>
                  <td>3</td>
                  <td>管理系统</td>
                  <td>cms</td>
                  <td>223</td>
                  <td><a href="<?php echo U(update_category);?>?current=6">修改</a> <a rel="3">删除</a></td>
                </tr>
                <tr>
                  <td>4</td>
                  <td>授人以渔</td>
                  <td>tutorial</td>
                  <td>12</td>
                  <td><a href="<?php echo U(update_category);?>?current=6">修改</a> <a rel="4">删除</a></td>
                </tr>
                <tr>
                  <td>5</td>
                  <td>程序人生</td>
                  <td>code</td>
                  <td>35</td>
                  <td><a href="<?php echo U(update_category);?>?current=6">修改</a> <a rel="5">删除</a></td>
                </tr>
              </tbody>
            </table>
