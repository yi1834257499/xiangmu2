...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          <tbody>
            <tr>
              <td>登录者: <span><?php echo (session('dusername')); ?></span>，这是您第 <span><?php echo (session('dcount')); ?></span> 次登录</td>
            </tr>
            <tr>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          ...
          <tbody>
            <tr>
              <td>管理员个数:</td>
              <td><?php echo (session('manageCount')); ?> 人</td>
              <td>服务器软件:</td>
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              <tr>
                <td wdith="20%">姓名:</td>
                <td width="80%"><input type="text" value="<?php echo ($data['realname']); echo ($data); ?>" placeholder="请完善" class="form-control" name="grealname" maxlength="10" autocomplete="off"></td>
              </tr>
              <tr>
                <td wdith="20%">用户名:</td>
                <td width="80%"><input type="text" readonly="readonly" value="<?php echo (cookie('user')); ?>" placeholder="请完善" class="form-control" name="gusername" maxlength="10" autocomplete="off"></td>
              </tr>
              <tr>
                <td wdith="20%">电话:</td>
                <td width="80%"><input type="text" value="<?php echo ($data['phone']); ?>" class="form-control" placeholder="请完善" name="gphone" maxlength="13" autocomplete="off"></td>
              </tr>
              <tr>
                <td wdith="20%">旧密码:</td>
                <td width="80%"><input type="password" class="form-control" name="old_password" maxlength="18" autocomplete="off"></td>
              ...
              <tr>
                <td wdith="20%">新密码:</td>
                <td width="80%"><input type="password" class="form-control" name="gpassword" maxlength="18" autocomplete="off"></td>
              </tr>
              <tr>
                <td wdith="20%">确认密码:</td>
                <td width="80%"><input type="password" class="form-control" name="new_password" maxlength="18" autocomplete="off"></td>
